...
public interface GeoServiceFacadeService {
     ...
     */
    PageResponse<GeoServiceInfo> queryService(GeoServicePageQueryRequest request);
     ...
     */
    OperateResponse<List<Long>> deleteService(GeoServiceQueryRequest request);
     ...
     */
    SingleResponse<GeoServiceInfo> getService(Long serviceId, String serviceMd5);
